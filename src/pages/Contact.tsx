      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white/80 backdrop-blur-sm relative z-10">
          <div className="container-custom">
            ...
            <div className="mt-16 animate-fade-up" style={{ animationDelay: '0.4s', opacity: 0 }}>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-bor-gold2/10">
                ...
                <div className="w-full h-80 rounded-lg overflow-hidden">
                  <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3940.212442996433!2d34.58200837583756!3d36.78396217225169!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzbCsDQ3JzAyLjMiTiAzNMKwMzUnMDQuNSJF!5e1!3m2!1str!2str!4v1745946301251!5m2!1str!2str" 
                    width="100%" 
                    height="100%" 
                    style={{ border: 0 }} 
                    allowFullScreen 
            ...
            {/* Office Hours */}
            <div className="mt-8 animate-fade-up" style={{ animationDelay: '0.5s', opacity: 0 }}>
              <h3 className="text-xl font-bold mb-4 text-bor-gold2-dark">{t('office_hours')}</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-white rounded-lg shadow-sm border border-bor-gold2/10 hover:border-bor-gold2/30 transition-all">
                  <h4 className="font-medium text-bor-gold2 mb-2">{t('monday_friday')}</h4>
                  <p className="text-gray-600">09:00 - 17:00</p>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm border border-bor-gold2/10 hover:border-bor-gold2/30 transition-all">
                  <h4 className="font-medium text-bor-gold2 mb-2">{t('saturday')}</h4>
                  <p className="text-gray-600">10:00 - 15:00</p>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm border border-bor-gold2/10 hover:border-bor-gold2/30 transition-all">
                  <h4 className="font-medium text-bor-gold2 mb-2">{t('sunday')}</h4>
                  <p className="text-gray-600">{t('closed')}</p>
                </div>
                <div className="p-4 bg-white rounded-lg shadow-sm border border-bor-gold2/10 hover:border-bor-gold2/30 transition-all">
                  <h4 className="font-medium text-bor-gold2 mb-2">{t('holidays')}</h4>
                  <p className="text-gray-600">{t('closed')}</p>
                </div>
              </div>
            </div>
